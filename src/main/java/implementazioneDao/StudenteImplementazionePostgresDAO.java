...
/**
 * La classe StudenteImplementazionePostgresDAO.
 * Gestidce i dati da passare al databse per conto dello studente.
 * E' implementata dalla calsse StudenteDAO.
 */
public class StudenteImplementazionePostgresDAO implements StudenteDAO {
    private Connection connessione;

    /**
     * Costruttore della classe StudenteImplementazionePostgresDAO.
     */
